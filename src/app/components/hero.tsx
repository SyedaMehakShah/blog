    ...
    <main className="py-10 bg-cyan-950">
      ...
      <section className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-gray-800 text-white rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 ease-in-out">
          <Image src={health} alt="AI in Healthcare - Revolutionizing healthcare with AI" className="h-48 w-full object-cover" />
          <div className="p-4">
            <h3 className="text-2xl font-semibold mb-2 text-gray-100">AI in Healthcare</h3>
        ...
        {/* AI & Robotics Card */}
        <div className="bg-gray-800 text-white rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 ease-in-out">
          <Image src={robot} alt="AI and Robotics - AI and robotics working together to automate industries" className="h-48 w-full object-cover" />
          <div className="p-4">
            <h3 className="text-2xl font-semibold mb-2 text-gray-100">AI & Robotics</h3>
            <p className="text-gray-300 mb-4">
        ...
        <div className="bg-gray-800 text-white rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 ease-in-out">
          <Image src={education} alt="AI in Education - AI reshaping education through personalized learning" className="h-48 w-full object-cover" />
          <div className="p-4">
            <h3 className="text-2xl font-semibold mb-2 text-gray-100">AI in Education</h3>
            <p className="text-gray-300 mb-4">
